...
async function adjustImage(imageData: ImageData, adjustments: string[], values: number[]) {
    ...
    wasm.batch_adjust(new Uint8Array(imageData.data.buffer), adjustments, new Float32Array(values));
